...
### 需要优化的地方
1，消费方和服务提供方没有保持心跳，在zookeeper挂掉的情况下，无法确认已缓存的服务提供方的连接是否有效<br>
2，消费方只是简单的对服务提供方做了roundrobin的路由策略，不支持一致性hash算法，这样在增加了服务提供方的情况下，会造成全局的服务抖动？<br>
3，服务端和消费端严重依赖Spring，对于一个中间件产品，对外依赖应该越少越好<br>
4，目前只支持probuf的序列化方式<br>
5，目前不支持http以及泛化调用<br>
